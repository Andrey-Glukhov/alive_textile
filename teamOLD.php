...
<div class="static_opener" id="opener_canvas"></div> 
  ...
  <div class="container-fluid people-background">
    <div class="row background-people-row">
      <div class="col-md-3 col-sm-5 col-5 d-none d-sm-block logo_side"> 
      </div>
      <div class="col-md-9 col-sm-7 col-12 people_side canvas_template">
      </div>
    </div>
  </div>
...
<div class="row organization_row">
  ...
  <div class="col-md-9 col-sm-7 col-12">
    ...
    <?php if ($organization == "interns"  ) { ?>
    <div class="portpet_intern">
     <p><?php the_sub_field('name'); ?></p>
		<p class="profession_light"><?php the_sub_field('profession'); ?></p>
    </div>
    <?php } else { ?>
